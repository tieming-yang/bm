...
const collectionItems = [
  { key: "metal", accent: "from-primary/20 via-background to-secondary/10" },
  { key: "wood", accent: "from-secondary/20 via-background to-primary/10" },
...
export default function BibleGiftsPage() {
  ...
  return (
    <div className="container px-4 py-16 mx-auto space-y-16">
        ...
        <div className="max-w-5xl space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {collectionItems.map((item) => (
              <div
                key={item.key}
                className={`relative h-full rounded-2xl border border-primary/20 bg-linear-to-b ${item.accent} p-6 shadow-lg shadow-primary/10`}
              >
                <div className="space-y-3">
      ...
      <section
        id="customization"
        className="relative px-8 py-10 overflow-hidden border shadow-lg rounded-3xl border-primary/20 bg-linear-to-r from-primary/5 via-background to-secondary/5"
      >
        <div className="absolute inset-0 pointer-events-none -z-10">
