...
export const bibleArtworks: BibleArtwork[] = [
  {
    ...
    scriptureTextZh: "起初，神創造天地。地是空虛混沌，淵面黑暗；神的靈運行在水面上。",
    bibleBook: "Genesis",
    bibleChapter: 1,
    bibleVerseStart: 1,
    bibleVerseEnd: 2,
  ...
  },
  {
    ...
    scriptureTextZh: "神愛世人，甚至將他的獨生子賜給他們，叫一切信他的，不致滅亡，反得永生。",
    bibleBook: "John",
    bibleChapter: 3,
    bibleVerseStart: 16,
...
export function getBibleArtworksByBook(book: string): BibleArtwork[] {
  return bibleArtworks.filter((artwork) => artwork.bibleBook === book);
}
